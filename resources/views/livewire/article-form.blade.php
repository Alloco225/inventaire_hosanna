<div class="modal-content">
    ...
    <form action="" method="POST" wire:submit.prevent="createArticle" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="checkbox" class="checkbox" wire:model="sortie_inventaire"></textarea>
        ...
        <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-primary">
                Ajouter <div wire:loading wire:target="submit"></div>
            </button>
        </div>
    </form>
</div>
