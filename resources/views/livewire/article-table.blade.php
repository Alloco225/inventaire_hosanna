                        ...
                        <div class="row align-items-center ml-5">
                            ...
                            <div class="col-md-3 my-2 my-md-0 ">
                                <div class="d-flex align-items-center">
                                    ...
                                    <select class="form-control" id="kt_datatable_search_status" wire:model="site_id">
                                        <option value=""></option>
                                ...
                                <div wire:loading wire:target="site_id">
                                    Updating quantity...
                                </div>
                            </div>
                                ...
                                <div class="col-md-3 my-2 my-md-0 ">
                                    <div class="d-flex align-items-center">
                                        <label class="mr-3 mb-0 d-none d-md-block">Etage:</label>
                                        <select class="form-control" wire:model="etage_id" >
                                            <option value=""></option>
                                ...
                                <div class="col-md-3 my-2 my-md-0">
                                    <div class="d-flex align-items-center">
                                        <label class="mr-3 mb-0 d-none d-md-block">Piece:</label>
                                        <select class="select form-control"  wire:model="piece_id">
                                            <option value=""></option>
                            ...
                            <table class="table  table-checkable" id="kt_datatable">
                                ...
                                <tbody>
                                    @foreach($articles as $article)
                                        <tr>
                                            <td><input class="checkbox" type="checkbox" value="{{$article->id}}" wire:model="article_tab"></td>
                                            <td>{{ $loop->index + 1 }}</td>
                                            ...
                                            <td>{{ $article->site->nom_site ?? ''}}</td>
                                            <td>{{ $article->etage->nom_etage ?? ''}}</td>
                                            <td>{{ $article->piece->nom_piece ?? ''}}</td>
                                            <td>{{ $article->sousCategorie->libelle ?? ''}}</td>
                                            <td class="d-flex">
                                                <a href="{{ route("article.show", $article) }}" class="btn btn-icon btn-light btn-sm mr-2">
                                                    @include("layouts.icons.arrow-right")
                                                </a>
                                                <button wire:click="edit({{$article->id}})" type="button" data-toggle="modal" data-target="#modalArticleUpdate"  class="btn btn-icon btn-light btn-sm mr-2">
