<div class="modal-content">
    ...
    <form action="" method="POST" wire:submit.prevent="createAppartement">
        <div class="modal-body">
            @csrf
            <div class="row">
                <div class="col-md-12 col-lg-6">
                    <div class="form-group">
                        <label id="nom_appartement">Nom <span class="text-danger">*</span></label>
                        <input type="text" class="form-control"  name="nom_etage" wire:model="nom_appartement" />
