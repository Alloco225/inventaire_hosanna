<div class="modal-content">
    ...
    <form action="" method="POST" wire:submit.prevent="updateDirection({{$directionId}})">
            ...
            <div class="row">
                <div class="col-md-12 col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"  name="nom_direction" wire:model="nom_direction" />
                        @error("nom_direction")
                ...
                <div class="col-md-12 col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="code_direction"  wire:model="code_direction" />
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nom_directeur" wire:model="nom_directeur"  />
                        @error("nom_directeur")
                        <span class="form-text text-danger">{{ $message }}</span>
                        @enderror
                    </div>
            ...
            <div class="row">
                <div class="col-md-12 col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control"  name="description_active" wire:model="description_activite"/>
